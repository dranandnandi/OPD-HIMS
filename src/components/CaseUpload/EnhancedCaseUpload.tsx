  ...
  const processImage = async (file: File) => {
    ...
    try {
      ...
      setProcessingStage({
        ...
        detail: 'Converting image to base64 format'
      });
      
      // Convert file to base64 (this is done inside processCasePaperWithAI)
      ...
      setProcessingStage({
        ...
        detail: 'Using Google Vision AI for OCR'
      });
      
      // Step 4: Medical Text Cleaning
      setProcessingStage({
        step: 4,
        total: 5,
        message: 'Cleaning medical text...',
        detail: 'Removing non-medical content with AI'
      });
      
      // Step 5: Medical Data Extraction
      setProcessingStage({
        step: 5,
        total: 5,
        message: 'Analyzing medical content...',
        detail: 'Extracting symptoms, diagnoses, and prescriptions'
      });
      ...
      setProcessingStage({ step: 0, total: 5, message: '', detail: '' });
    }
  };
      ...
      {step === 'processing' && (
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <h4 className="font-medium text-blue-800 mb-3">AI Processing Pipeline:</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 text-sm">
              ...
              <div className={`flex items-center gap-2 ${processingStage.step >= 5 ? 'text-blue-700' : 'text-gray-500'}`}>
                <div className={`w-4 h-4 rounded-full flex items-center justify-center text-xs ${
                  processingStage.step > 5 ? 'bg-green-500 text-white' : 
                  processingStage.step === 5 ? 'bg-blue-500 text-white' : 'bg-gray-300'
                }`}>
                  {processingStage.step > 5 ? '✓' : '5'}
                </div>
