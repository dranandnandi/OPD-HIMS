  ...
  const loadSettings = async () => {
    try {
      ...
      setFormData({
        ...
        enableBlueticksApiSend: clinicSettings.enableBlueticksApiSend ?? false,
        ...
        blueticksApiKey: clinicSettings.blueticksApiKey || '',
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updatedSettings = await clinicSettingsService.updateClinicSettings(settings.id, {
        ...
        enableBlueticksApiSend: formData.enableBlueticksApiSend,
        ...
        blueticksApiKey: formData.blueticksApiKey,
    ...
    <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-medium text-gray-800">Direct API Send (Blueticks)</h4>
                <p className="text-sm text-gray-600">Send messages directly via Blueticks API</p>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
                checked={formData.enableBlueticksApiSend}
                onChange={(e) => setFormData({ ...formData, enableBlueticksApiSend: e.target.checked })}
                className="sr-only peer"
              />
          ...
          {/* Blueticks API Key */}
          {formData.enableBlueticksApiSend && (
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <div className="relative">
                <input
                  ...
                  value={formData.blueticksApiKey}
                  onChange={(e) => setFormData({ ...formData, blueticksApiKey: e.target.value })}
                  ...
                  placeholder="Enter your Blueticks API key"
                />
                <button
                  type="button"
              ...
              <p className="text-xs text-blue-600 mt-1">
                Get your API key from <a href="https://blueticks.co" target="_blank" rel="noopener noreferrer" className="underline">Blueticks.co</a>
              </p>
            </div>
          )}
        </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <ul className="text-sm text-blue-700 space-y-2">
          ...
          <li>• <strong>Direct Send:</strong> Automatically sends messages via Blueticks API (requires API key)</li>
