...
const InvoiceUpload: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Call the parse-pharmacy-invoice edge function
      const response = await fetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/parse-pharmacy-invoice`, {
        method: 'POST',
        headers: {
      ...
      {step === 'processing' && (
        <div className="bg-white rounded-lg shadow-md p-12 text-center">
          ...
          <div className="space-y-2 text-gray-600">
            <p>Step 1: Extracting text from invoice...</p>
            <p>Step 2: Analyzing invoice data with AI...</p>
            <p>Step 3: Structuring medicine information...</p>
          </div>
